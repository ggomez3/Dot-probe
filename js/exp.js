...
const block_para_lists = [{
    ...
    + "<p>Shortly after, a key will appear on screen, '<' (left) or '>' (right), will appear on screen.</p>"
    +"<p>Respond by pressing the arrow key on your keyboars that corresponds to the direction of the key on screen</p>", 
